			...
			<div  class="row jumbotron justify-content-center">		
				<div class="container-fluid padding">
					<div class="row text-center padding">
						<div class="col-xs-12">
							<img class="fas avatar" src="img/face_6.jpg">
							<h3>Виктор Ляшенко</h3>
			...
			<!-- Форма -->
					<div class="justify-content-center ">
						<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							...
							<a src="face_6.php"><button name="submit" class="btn btn-success btn-lg" type="submit">Оставить отзыв</button></a>
							<br><br>
						</form>
					</div>
