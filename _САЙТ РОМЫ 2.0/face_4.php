			...
			<div  class="row jumbotron justify-content-center">		
				<div class="container-fluid padding">
					<div class="row text-center padding">
						<div class="col-xs-12">
							<img class="fas avatar" src="img/face_4.jpg">
							<h3>Игорь Ерошкин</h3>
							<span>Психолог. Стаж 9 лет.</span>
							<p style="color: #969696;">Стаж с 2011. Психосоматика. Личностный рост. 
					Детско - Родительские отношения. Межличностные отношения. Буду рад Вам помочь!</p>
						</div>
					</div>
				</div>
			</div>
			...
			<!-- Форма -->
					<div class="justify-content-center ">
						<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
							...
							<a src="face_4.php"><button name="submit" class="btn btn-success btn-lg" type="submit">Оставить отзыв</button></a>
							<br><br>
						</form>
					</div>
